...
const safariExperiences = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1663498798455-8ce6d44d4505?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "5 Days",
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1661860529833-ce240a1632be?q=80&w=2034&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    duration: "6 Days",
...
export function FeaturedSafaris() {
  ...
  return (
    <section id="Featured" ref={sectionRef} className="py-20 px-4 sm:px-6 bg-stone-100">
